...
async def on_end_handler(client, update: Update):
   if isinstance(update, StreamAudioEnded):
      ...
      if op==1:
         await bot.send_message(chat_id, "🥺 **Nᴏᴛʜɪɴɢ ɪs ɪɴ ᴘʟᴀʏʟɪsᴛ ɪ'ᴍ ʟᴇᴀᴠɪɴɢ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ...**")
      elif op==2:
         await bot.send_message(chat_id, "**Eʀʀᴏʀ ᴀᴄᴄᴜʀᴇᴅ** \n**Cʟᴇᴀʀɪɴɢ ᴛʜᴇ ᴘʟᴀʏʟɪsᴛ ᴀɴᴅ ʟᴇᴀᴠɪɴɢ ᴛʜᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ...**")
      else:
         await bot.send_message(chat_id, f"**🎧 Nᴏᴡ ᴘʟᴀʏɪɴɢ** \n[{op[0]}]({op[1]}) | `{op[2]}`")
